...
import { Personagem, Guerreiro, Mago, Atirador, Tanque } from "./Personagem";
import { Inimigo } from "./Inimigo";
import { Item, Espada, Cajado, Arco, Martelo } from "./Item";





function verificaRaridade(raridade: string | number, dano: number): void {
